...
public class AccountServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "add": {
          service.add(json.getJsonObject("account") == null ? null : new com.condoway.account.Account(json.getJsonObject("account")), createHandler(msg));
          break;
        }
        case "retrieve": {
          service.retrieve((java.lang.String)json.getValue("id"), res -> {
            if (res.failed()) {
        ...
        case "retrieveByEmail": {
          service.retrieveByEmail((java.lang.String)json.getValue("email"), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
        ...
        case "update": {
          service.update(json.getJsonObject("account") == null ? null : new com.condoway.account.Account(json.getJsonObject("account")), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
