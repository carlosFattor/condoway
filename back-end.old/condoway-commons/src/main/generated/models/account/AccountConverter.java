...
/**
 * Converter for {@link models.account.Account}.
 *
 * NOTE: This class has been automatically generated from the {@link models.account.Account} original class using Vert.x codegen.
 */
public class AccountConverter {

  public static void fromJson(JsonObject json, Account obj) {
    if (json.getValue("roles") instanceof JsonArray) {
      java.util.ArrayList<models.general.Roles> list = new java.util.ArrayList<>();
      json.getJsonArray("roles").forEach( item -> {
        if (item instanceof String)
          list.add(models.general.Roles.valueOf((String)item));
      });
      obj.setRoles(list);
    }
