...
public class AccountServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "save": {
          service.save(json.getJsonObject("account") == null ? null : new models.account.Account(json.getJsonObject("account")), createHandler(msg));
          break;
        }
        case "retriever": {
          service.retriever((java.lang.String)json.getValue("userID"), res -> {
            if (res.failed()) {
        ...
        case "remove": {
          service.remove((java.lang.String)json.getValue("userID"), createHandler(msg));
          break;
        }
        default: {
